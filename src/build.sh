...
# TODO: need to set dev/prd for the repo name
# TODO: need to version the containers
docker tag brendanbeck62/bbcom:latest 356960567614.dkr.ecr.us-west-2.amazonaws.com/brendanbeckcom-repo-prod:latest
docker push 356960567614.dkr.ecr.us-west-2.amazonaws.com/brendanbeckcom-repo-prod:latest
